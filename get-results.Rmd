...
source(file.path("run-analysis.R"))
```
...
#  mutate(Y_delta62 = replace(Y_delta62, hrs_elapsed_invite_to_first_reminder>62, 0))
...
Treatment indictor was coded as '1' for 'Product' and '0' for 'Charity'.
