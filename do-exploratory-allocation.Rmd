...
kable(cnt6, format="latex", booktabs=TRUE, caption = "At the current decision point t, we will exclude participant-decision points belonging to participants who were not invited to self-monitor at the previous decision point t-1 (i.e., these were the participants who were classified as heavy drinkers at t-2). Note that only participants who complete self-monitoring at t-1 would have the opportunity to allocate points.") %>% 
  kable_styling(latex_options = c("HOLD_position"))
```
